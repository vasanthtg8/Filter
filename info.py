...
SHORTLINK_API = environ.get('SHORTLINK_API', '408b3648a480780fd736581d4ea9673850423e8f')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+DzSaWIdtYz5jOWQ9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviesU2')
TUTORIAL = environ.get('TUTORIAL', 'No tutorial guys')
...
URL = "https://moviesuniverse-825c494655ce.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviesuniverse-825c494655ce.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviesuniverse-825c494655ce.herokuapp.com/".format(FQDN)
else:
    URL = "https://moviesuniverse-825c494655ce.herokuapp.com/".format(FQDN)
