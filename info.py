...
API_ID = int(environ.get('API_ID', '2017227999'))
API_HASH = environ.get('API_HASH', '2e50ff91_e3a07d6bd74da72e')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://moonknight11220:PLRTJHeiP4M1KdG2@cluster0.yzmdsb3.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "moonknight11220")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001176901973'))
